...
import movieNightImg from "../../assets/movie-night2.png";
import notWhatsImg from "../../assets/not-whats-project.png";
          ...
          ({ title, description, image, website, repository }) => (
            <>
              <motion.div
                ...
                viewport={{ once: true }}
                className="flex flex-col items-center rounded-md sm:flex-row drop-shadow-md bg-white text-black mx-8"
              >
                <Image
