        ...
        >
          <div className="relative">
            <input
              name="name"
              required
              className="peer flex w-full rounded-md focus:border-[#8257E6] focus:ring-[#8257E6] focus:drop-shadow-md text-black"
              type="text"
              id="name"
            />
            <label
          ...
          <div className="relative">
            <textarea
              name="message"
              required
              className="peer flex w-full rounded-md focus:border-[#8257E6] focus:ring-[#8257E6] focus:drop-shadow-md text-black h-40 resize-none"
              id="message"
              rows={4}
              cols={50}
            />
          ...
          >
            {contactMessageStatus === "waiting" && (
              <div className="w-full h-full p-2 bg-[#8257E6] rounded-md flex justify-center items-center gap-4">
                <BsFillEnvelopeFill />
